...
class Api{
  ...
  static final String BIND_UID_URL = '/crm/app/interface.php?action=bindUid&token=';


  static final String CHECK_ONLINE = '/crm/app/interface.php?action=checkIsOnLine&token=';


  static final String REPLAY = '/crm/app/interface.php?action=replay&token=';
