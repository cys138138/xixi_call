...
class Api{
  static final String BASE_HOST = "http://192.168.1.243/index.php";
  static final String SOCKET_HOST = "ws://192.168.1.243:8282";
  ...
  static final String LOGIN_URL = "/api/company/login.html";

  static final String REPLAY_URL = "/api/app_call/replay.html?token=";
  ...
  static final String BIND_UID_URL = '/api/app_call/bind_scoket_uid.html?token=';


  static final String CHECK_ONLINE = '/api/app_call/checkIsOnLine.html?token=';
